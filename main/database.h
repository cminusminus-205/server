...
public:
	...
	void wipe(){
		...
		*this << new Query("CREATE TABLE chat (id INTEGER UNIQUE PRIMARY KEY, sent_by TEXT NOT NULL, message TEXT, time TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP, IS_SIMULATION TEXT);");
