...
public:
	...
	void wipe(){
		...
		*this << new Query("CREATE TABLE emergencies (id INTEGER UNIQUE PRIMARY KEY, type TEXT NOT NULL, latitude DOUBLE, longitude DOUBLE, time TEXT, status INTEGER, location TEXT);");
